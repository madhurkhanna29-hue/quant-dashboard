...
def run_strategy(df):
    ...
    # Calculate exact execution entry points for mapping
...
# --- SECTION 1 (UPDATED WITH INTERACTIVE PLOT) ---
...
# Slice data for the plot to maintain top performance on mobile (last ~2 years)
...
# Layout configurations for responsive mobile viewing
fig.update_layout(
...
# --- 5. TOMORROW'S TRIGGER CALCULATOR ---
